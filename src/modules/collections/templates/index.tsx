  ...
  return (
    <div className="content-container ">
      <div className="mb-8 text-2xl-semi">
        <h1 className="p-8">{collection.title}</h1>
        <p className="text-sm p-8 pt-4">{collection.metadata.subDescription}</p>
      </div>
      <ul className="grid grid-cols-2 small:grid-cols-3 medium:grid-cols-4 ">
        {previews.map((p) => (
          <li key={p.id}>
            <ProductPreview {...p} />
          </li>
